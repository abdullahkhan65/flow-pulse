  ...
  return (
    <div className="min-h-screen pb-14">
      ...
      <main className="mx-auto w-full max-w-4xl px-5 pt-10 md:px-8 md:pt-14">
        {isLoading && <div className="card h-72 animate-pulse bg-slate-100" />}
        ...
        {data && (
          <article className="card p-7 md:p-10">
            ...
            <p className="mt-4 text-base text-slate-600">{data.summary}</p>
            ...
            <div className="mt-8 whitespace-pre-wrap text-sm leading-7 text-slate-700 md:text-base">
              {data.content}
            </div>
