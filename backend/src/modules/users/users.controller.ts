...
export class UsersController {
  ...
  updateProfile(@CurrentUser() user: JwtPayload, @Body() body: { name?: string; timezone?: string }) {
    return this.usersService.updateProfile(user.sub, body);
  }

  @Patch('me/consent')
  @ApiOperation({ summary: 'Update data collection consent — revoke to delete all your data' })
  updateConsent(@CurrentUser() user: JwtPayload, @Body() body: { consent: boolean }) {
  ...
  @Delete('me/data')
  @ApiOperation({ summary: 'Delete all my collected data (GDPR right to erasure)' })
