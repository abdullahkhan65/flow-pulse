...
export class GithubController {
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: "Update GitHub sync settings (time window + repo allowlist)",
  })
  async updateSettings(
    ...
    await this.githubService.updateSyncSettings(user.sub, {
      timeWindowDays,
      repoAllowlist,
    });
    return { success: true };
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: "Debug GitHub integration ingestion status for current user",
  })
